...
-- Command     : write_vhdl -force -mode funcsim e:/GIT/coa-design/cpu/cpu.srcs/sources_1/ip/ROM1/ROM1_sim_netlist.vhdl
-- Design      : ROM1
...
architecture STRUCTURE of ROM1_rom is
  ...
  attribute SOFT_HLUTNM of \spo[12]_INST_0_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \spo[14]_INST_0_i_1\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \spo[6]_INST_0_i_1\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \spo[9]_INST_0_i_1\ : label is "soft_lutpair12";
begin
...
\spo[19]_INST_0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\spo[9]_INST_0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
entity ROM1_dist_mem_gen_v8_0_12 is
  ...
  attribute C_FAMILY of ROM1_dist_mem_gen_v8_0_12 : entity is "virtex7";
  ...
  attribute C_WIDTH of ROM1_dist_mem_gen_v8_0_12 : entity is 32;
  attribute ORIG_REF_NAME : string;
...
architecture STRUCTURE of ROM1_dist_mem_gen_v8_0_12 is
  ...
  signal \synth_options.dist_mem_inst_n_25\ : STD_LOGIC;
begin
  dpo(31) <= \<const0>\;
  dpo(30) <= \<const0>\;
  dpo(29) <= \<const0>\;
...
\synth_options.dist_mem_inst\: entity work.ROM1_dist_mem_gen_v8_0_12_synth
     port map (
      a(7 downto 0) => a(7 downto 0),
      spo(24 downto 18) => \^spo\(30 downto 24),
      spo(17 downto 15) => \^spo\(19 downto 17),
      spo(14 downto 13) => \^spo\(15 downto 14),
      spo(12 downto 0) => \^spo\(12 downto 0),
...
entity ROM1 is
  ...
  attribute x_core_info of ROM1 : entity is "dist_mem_gen_v8_0_12,Vivado 2018.2";
end ROM1;
